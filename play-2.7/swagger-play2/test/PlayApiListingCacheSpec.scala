...
import io.swagger.models.{ArrayModel, HttpMethod, ModelImpl, RefModel}
...
PUT /api/dog/api/:id testdata.DogController.add0(id:String)
  ...
  "ApiListingCache" should {
    ...
    "load all API specs" in {
      ...
      opCatGet.getParameters.size() must beEqualTo(0)
      ...
      opCatPut.getParameters.get(0).getName must beEqualTo("cat")
      opCatPut.getParameters.get(0).getIn must beEqualTo("body")
      opCatPut.getParameters.get(0).asInstanceOf[BodyParameter].getSchema.getReference must beEqualTo("#/definitions/Cat")
      opCatPut.getConsumes must beNull
      opCatPut.getResponses.get("200").getResponseSchema.asInstanceOf[RefModel].getSimpleRef must beEqualTo("ActionAnyContent")
      ...
      opCatGet43.getParameters.get(0).asInstanceOf[QueryParameter].getType must beEqualTo("integer")
      ...
      opDogGet.getParameters.size() must  beEqualTo(0)
      ...
      opDogPut.getParameters.get(0).getName must beEqualTo("dog")
      opDogPut.getParameters.get(0).getIn must beEqualTo("body")
      opDogPut.getParameters.get(0).asInstanceOf[BodyParameter].getSchema.getReference must beEqualTo("#/definitions/Dog")
      opDogPut.getConsumes.asScala.toList must beEqualTo(List("application/json","application/xml"))
      opDogPut.getResponses.get("200").getResponseSchema.asInstanceOf[RefModel].getSimpleRef must beEqualTo("ActionAnyContent")
      ...
      opDogParamPut.getParameters.get(0).getName must beEqualTo("id")
      opDogParamPut.getParameters.get(0).getIn must beEqualTo("path")
      opDogParamPut.getParameters.get(0).asInstanceOf[PathParameter].getType must beEqualTo("string")
      ...
      opDogParamPut.getResponses.get("200").getResponseSchema.asInstanceOf[RefModel].getSimpleRef must beEqualTo("ActionAnyContent")
